...
- Import-recovery and keyboard checks completed. Null-root JSON now produces an actionable validation message, and invalid/conflicting imports preserve existing captures and notes. The local API also rejects null input as a 400 validation error. See [qa/import-recovery-2026-09-24.md](qa/import-recovery-2026-09-24.md).
- GitHub Actions tests and Pages deployment passed at application commit `172f9be7f1d8e840c5bb9db832f52730baa874ca` ([run](https://github.com/luoy16002-svg/iris-change-atlas/actions/runs/36011217350)). The public browser was refreshed and the corrected import path was verified. Later documentation-only commits do not change the application behavior.
